...
public class text1 extends JFrame{
    ...
    private String [][] boxs1 = new String[][]{{"1","2","3"},
            {"4","5","6"},
            {"7","8"," "}};
    private JLabel [] jl = new JLabel [9];//4*4
    ...
    private void initComp(){
        ...
        {
            jl[i] = new JLabel();
            jl[i].setFont(new Font("t1",Font.ITALIC,80));
            cp.add(jl[i]);
        }
        boxs1 = num();
            ...
            public void actionPerformed(ActionEvent e) {
                if(e.getSource() == g1) //投降
                {
                    ...
                    for(int i=0; i< jl.length; i++)//初始化數字顯示的位置//15+1=16
                    {
                        ...
                        if(boxs1[i/boxs1.length][i%boxs1.length].equals("9")) boxs1[i/boxs1.length][i%boxs1.length] = " ";
                        jl[i].setText("  ");//清空
                    }
                    boxs1 = num();
        ...
        this.addKeyListener(new KeyListener() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (flag==true) {
                    ...
                    //判斷是否過關
                    if(boxs1[0][0].equals("1") && boxs1[0][1].equals("2") &&
                            boxs1[0][2].equals("3") && boxs1[1][0].equals("4") &&
                            boxs1[1][1].equals("5") && boxs1[1][2].equals("6") &&
                            boxs1[2][0].equals("7") && boxs1[2][1].equals("8") &&
                            boxs1[2][2].equals(" ")
                            )
                    {
